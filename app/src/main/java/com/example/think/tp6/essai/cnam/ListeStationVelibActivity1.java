...
public class ListeStationVelibActivity1 extends ListActivity {
    ...
    private class ChargeurListeDesStations extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... str) {
            try {
                ...
                e.printStackTrace();
                try {
                    InputStream is = ListeStationVelibActivity1.this.getAssets().open("stations.xml");
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            setListAdapter(new ArrayAdapter<String>(ListeStationVelibActivity1.this,android.R.layout.simple_list_item_1,stations.lesNomsDesStations()));
        }
    }
    ...
    private class ChargeurInfoStation extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if(progressDialog.isShowing())
                progressDialog.dismiss();
            Intent intent=new Intent(ListeStationVelibActivity1.this,InfoStationActivity.class);
